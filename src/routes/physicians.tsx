  ...
  head: () => ({
    meta: [
      { title: "For Physicians — BioBlend Compounding Pharmacy Dubai" },
      {
        name: "description",
        content:
          "Partner with BioBlend on bespoke formulations. DHA-licensed compounding, direct pharmacist access, and a growing formulary for prescribing physicians in the UAE.",
      },
      { property: "og:title", content: "For Physicians — BioBlend Compounding Pharmacy" },
      {
        property: "og:description",
        content: "A partner pharmacy for prescribers who want precise, personalized formulations.",
      },
...
const pillarsEn: Pillar[] = [
  {
    tile: "nutraceutical",
    title: "Bespoke formulary",
    body: "Micro-doses, delivery-form conversions, allergen-free bases, taste-masking — we co-design with you.",
  },
  {
    tile: "sterile",
    title: "DHA-licensed & audited",
    body: "USP <795> non-sterile and USP <797> sterile compliance. Full batch documentation on request.",
  },
  {
    tile: "partnership",
    title: "Direct pharmacist line",
    body: "A named pharmacist for your practice — no call centre. WhatsApp, phone, email — response inside the hour.",
  },
  {
    tile: "hormone",
    title: "Digital Rx workflow",
    body: "Send prescriptions by secure link. Refill tracking and adherence notes flow back to your patient chart.",
  },
];
...
const pillarsAr: Pillar[] = [
  {
    tile: "nutraceutical",
    title: "تركيبات مصمّمة حسب طلبك",
    body: "جرعات دقيقة، تحويل بين الأشكال الدوائية، قواعد خالية من المسبّبات، وإخفاء الطعم — نصمّمها معك خطوة بخطوة.",
  },
  {
    tile: "sterile",
    title: "مرخّصون من DHA ومدقّقون",
    body: "التزام كامل بمعايير USP <795> غير المعقّمة و USP <797> المعقّمة، مع توفير كامل توثيق الدُفعات عند الطلب.",
  },
  {
    tile: "partnership",
    title: "خط مباشر مع صيدلي مخصّص",
    body: "صيدلي معيّن لعيادتك بالاسم — لا مركز اتصال. رد على واتساب أو الهاتف أو البريد خلال أقل من ساعة.",
  },
  {
    tile: "hormone",
    title: "نظام وصفات رقمي",
    body: "أرسل وصفاتك عبر رابط آمن. نُعيد لك ملاحظات الالتزام وإعادة الصرف مباشرة إلى ملف مريضك.",
  },
];
...
const workflowEn = [
  {
    n: "01",
    title: "Onboard",
    body: "One 30-minute call with our lead pharmacist to map your commonly-prescribed formulations.",
  },
  {
    n: "02",
    title: "Prescribe",
    body: "Send Rx via secure link, encrypted email, or e-prescription network.",
  },
  { n: "03", title: "Compound", body: "Prepared in-lab within 24-72h depending on formulation." },
  {
    n: "04",
    title: "Deliver & follow-up",
    body: "Discreet delivery to your patient. Adherence and refill notes shared back.",
  },
];
...
const workflowAr = [
  {
    n: "٠١",
    title: "الانضمام",
    body: "مكالمة واحدة 30 دقيقة مع كبير الصيادلة عندنا لحصر الوصفات التي تكتبها بشكل متكرّر.",
  },
  {
    n: "٠٢",
    title: "إرسال الوصفة",
    body: "أرسل الوصفة عبر رابط آمن، أو بريد مشفّر، أو منظومة الوصفات الإلكترونية.",
  },
  { n: "٠٣", title: "التحضير", body: "نُحضّرها في مختبرنا خلال 24 إلى 72 ساعة حسب نوع التركيبة." },
  {
    n: "٠٤",
    title: "التوصيل والمتابعة",
    body: "توصيل بسريّة تامّة لمريضك، مع مشاركة ملاحظات الالتزام وإعادة الصرف معك.",
  },
];
...
const specialtiesAr = [
  ...
  "الأمراض الجلدية",
  "طب الأطفال",
  "الطب الوظيفي وطول العمر",
  "علاج الألم",
  "صحة المرأة",
  "الطب الرياضي",
  "عيادات الطب التكاملي والعافية",
];
    ...
    <>
          ...
          <Reveal>
            ...
            <h1 className="mt-6 font-serif text-5xl leading-[1.02] md:text-6xl">
              {ar ? (
                ...
                <>
                  A pharmacy that <em className="italic text-[color:var(--brand-gold)]">extends</em>{" "}
                  your practice.
                </>
              )}
            </h1>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              >
                <a href="tel:+97143277355">
                  {ar ? "تحدّث مع كبير الصيادلة" : "Speak to lead pharmacist"}{" "}
            ...
            <div className="relative hidden lg:block">
              <div className="gold-frame overflow-hidden rounded-3xl">
                <img
                  ...
                  alt={
                    ar
                      ? "صيدلي بايوبلند يتشاور مع طبيب"
                      : "BioBlend pharmacist consulting with a physician"
                  }
              ...
              <div className="absolute -bottom-6 -left-6 hidden rounded-2xl bg-[color:var(--brand-gold)] px-5 py-4 text-primary shadow-luxe md:block">
                <p className="font-serif text-lg leading-tight">
                  {ar ? "صيدلي مخصّص" : "Named pharmacist"}
                </p>
                <p className="text-[0.65rem] tracking-[0.24em] uppercase opacity-80">
                  {ar ? "لعيادتك" : "for your practice"}
                </p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal>
            <SectionHeading
              ...
              title={
                ar ? (
                  <>
                    دقّة، <em className="italic text-[color:var(--brand-gold)]">مسؤولية</em>، وخطّ
                    مباشر معك.
                  </>
                ) : (
                  <>
                    Precision,{" "}
                    <em className="italic text-[color:var(--brand-gold)]">accountability</em>, and a
                    direct line.
                  </>
                )
              }
      ...
      <section className="bg-secondary/60">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <Reveal>
            <SectionHeading
              eyebrow={ar ? "سير العمل" : "The workflow"}
              align="center"
              title={
                ar ? (
                  <>
                  ...
                  <>
                    ...
                    <em className="italic text-[color:var(--brand-gold)]">patient</em>
                  </>
                )
              }
            />
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-6xl px-6 py-24 lg:px-10">
          <Reveal>
            <SectionHeading
              eyebrow={ar ? "التخصّصات التي ندعمها" : "Specialties we support"}
              title={
                ar ? (
                  <>
                    تركيبات{" "}
                    <em className="italic text-[color:var(--brand-gold)]">متعدّدة التخصّصات</em>
                  </>
                ) : (
                  <>
                    Cross-disciplinary{" "}
                    <em className="italic text-[color:var(--brand-gold)]">compounding</em>
                  </>
                )
              }
            />
        ...
        <div className="mx-auto max-w-4xl px-6 py-20 text-center lg:px-10">
          <Reveal>
            <h2 className="font-serif text-4xl leading-tight md:text-5xl">
              {ar ? (
                <>
                  أرسل <em className="italic text-[color:var(--brand-gold)]">وصفتك القادمة</em> إلى
                  بايوبلند.
                </>
              ) : (
                <>
                  Bring your{" "}
                  <em className="italic text-[color:var(--brand-gold)]">next prescription</em> to
                  BioBlend.
                </>
              )}
            </h2>
