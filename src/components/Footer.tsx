        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-primary-foreground/80">
              <li><Link to="/" className="hover:text-[color:var(--brand-gold)]">{t.home}</Link></li>
              <li><Link to="/services" className="hover:text-[color:var(--brand-gold)]">{t.services}</Link></li>
              <li><Link to="/about" className="hover:text-[color:var(--brand-gold)]">{t.about}</Link></li>
              <li><Link to="/insights" className="hover:text-[color:var(--brand-gold)]">{t.insights}</Link></li>
              <li><Link to="/physicians" className="hover:text-[color:var(--brand-gold)]">{t.physicians}</Link></li>
              <li><Link to="/corporate" className="hover:text-[color:var(--brand-gold)]">{t.corporate}</Link></li>
              <li><Link to="/contact" className="hover:text-[color:var(--brand-gold)]">{t.contact}</Link></li>
            </ul>
          </div>
